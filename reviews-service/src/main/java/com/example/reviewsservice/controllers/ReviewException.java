...
public class ReviewException extends RuntimeException {
    ...
    public static final String REVIEW_DOES_NOT_EXISTS = "Review do not exists";
    public static final String REVIEW_ALREADY_EXISTS = "There is already a review for that product";
    public static final String PRODUCT_DOES_NOT_EXISTS = "Product do not exists";
    public static final String ORDER_DOES_NOT_EXIST = "Order do not exist";
